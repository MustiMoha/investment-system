...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-[#7d471e] dark:text-[var(--dark-text)]">Analytics Dashboard</h2>
              ...
              <table className="min-w-full border-separate border-spacing-0 text-xs">
                ...
                <tbody>
                  {db.investors.map((inv) => {
                    ...
                    return (
                      <tr key={inv.id} className="border-t border-slate-200 dark:border-[var(--dark-border)]">
      ...
      {/* Note about tracking */}
      <div className="rounded-xl border border-slate-200 dark:border-[var(--dark-border)] bg-white dark:bg-gradient-to-b dark:from-[var(--dark-surface-alt)] dark:via-[var(--dark-surface)] dark:to-[var(--dark-surface)] p-4">
        <p className="text-xs text-slate-600 dark:text-[var(--dark-text-muted)]">
          <strong className="text-[#7d471e] dark:text-[var(--dark-text)]">Note:</strong> Analytics tracking is
